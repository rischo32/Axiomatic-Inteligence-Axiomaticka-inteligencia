> Tento repozitár je nástrojom. Nie je to súd. Nerobí rozhodnutia za teba — len meria, zaznamenáva a núti k zodpovednosti. Používaj ho s rozumom a s rešpektom voči životu.
